...
class APIService {
    ...
    func fetchSong(for albumID: Int, completion: @escaping(Result<SongResult, APIError>) -> Void) {
    ...
    func fetchMovie(searchTerm: String, completion: @escaping(Result<MovieResult, APIError>) -> Void) {
